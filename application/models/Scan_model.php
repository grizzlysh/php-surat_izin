...
class Scan_model extends CI_Model
{
    ...
    {
        return $this->db->get("m_scan")->result();
    }
    
    public function getById($id)
    {
        return $this->db->get_where("m_scan", ["kd_izin" => $id])->row();
    }

    public function save($data)
    {
        $this->db->insert("m_scan",$data);
    }
