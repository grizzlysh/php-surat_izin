            ...
            <div class="panel-body">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body text-center" >
                                ...
                                <br>Pengajuan izin ini telah <b><?php echo $h_hasil?></b> oleh Atasan.
                                <h1 style="text-align:center"><a href="http://localhost/s_ali/personalia/change_status?id=<?php echo $kode?>">[Accept]</a></h1>
                                <h1 style="text-align:center"><a href="http://localhost/s_ali/personalia/change_status_t?id=<?php echo $kode?>">[Reject]</a></h1>
