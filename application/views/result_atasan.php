                            ...
                            <div class="panel-body text-center" >
								...
								?>  
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <form action="http://localhost/s_ali/Atasan/validasi" method="post" enctype="multipart/form-data" >
                                                ...
                                                <div class="form-group">
                                                    <!-- <a href="<?php echo site_url('Atasan/validasi?id='. $no) ?>"i class="btn btn-primary">Submit</a> -->
