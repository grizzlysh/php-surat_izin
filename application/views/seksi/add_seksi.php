...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Input Seksi</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
            ...
            <div class="row">
                ...
                <div id="content-wrapper">
                    <div class="col-md-6">
                        ...
                        <form action="<?php base_url('admin/addSeksi') ?>" method="post" enctype="multipart/form-data" >
                        		
								<div class="form-group">
									<label for="nama">Nama Seksi*</label>
									<input class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>"
									type="text" name="nama" placeholder="Nama Seksi" />
									<div class="invalid-feedback">
										<?php echo form_error('nama') ?>
									</div>
								</div>
                                <input class="btn btn-primary btn-sm" type="submit" name="btn" value="Simpan" />  &nbsp &nbsp 
							<a href="<?php echo site_url('Admin/viewSeksi') ?>" class="btn btn-danger btn-sm"> Kembali </a> 
                        </form>
                    </div>
                </div>
                </div>
