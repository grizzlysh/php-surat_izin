            ...
            <div class="panel-body">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body text-center" >
                                ...
                                <h2> <?php echo $kode ?> </h2>
                                <br>
                                Pengajuan surat izin Anda, dengan detail sebagai berikut:<br>
                                ...
                                <br>Pengajuan izin ini anda telah <b><?php echo $h_hasil?></b> oleh HRD Personalia.
                                <br>Silahkan cetak dan tunjukkan tiket ini kepada <i>Security</i> untuk izin keluar.
                                <!-- <br>Barcode : <img src="<?php //echo $h_qrcode ?>"> -->
                                <h1 style="text-align:center"><a href="http://localhost/s_ali/user/cetakTiket?id=<?php echo $kode?>">[Cetak Tiket]</a></h1>
